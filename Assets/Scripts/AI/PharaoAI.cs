...
namespace DM
{
    public class PharaoAI : EnemyAI
    {
        ...
        private void ComputePath()
        {
            ...
            Node startNode = MapManager.Instance.nodeSystem.GetNodeAt(movement.movePoint.position);
            Node endNode = MapManager.Instance.nodeSystem.GetNodeAt(currentTargetPosition);
